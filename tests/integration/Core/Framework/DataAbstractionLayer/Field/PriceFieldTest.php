...
EOF;
    ...
    public static function cashRoundingSortingProvider(): iterable
    {
        ...
        yield '0.01 interval default currency' => [
            [
        ...
        yield '0.01 interval currency fallback' => [
            [
        ...
        yield '0.05 interval default currency' => [
            [
        ...
        yield '0.05 interval currency fallback' => [
            [
    ...
    public static function cashRoundingFilterProvider(): iterable
    {
        ...
        yield '0.10 interval default currency' => [
        ...
        yield '0.10 interval currency fallback' => [
            new RangeFilter('data', [RangeFilter::GTE => 19.41, RangeFilter::LTE => 19.50]),
            [
        ...
        yield '0.50 interval default currency' => [
        ...
        yield '0.50 interval currency fallback' => [
            new RangeFilter('data', [RangeFilter::GTE => 19.01, RangeFilter::LTE => 20.00]),
            [
        ...
        yield '1.00 interval default currency' => [
            new RangeFilter('data', [RangeFilter::GTE => 19.01, RangeFilter::LTE => 20.00]),
            [
        ...
        yield '1.00 interval currency fallback' => [
            new RangeFilter('data', [RangeFilter::GTE => 19.01, RangeFilter::LTE => 20.00]),
            [
