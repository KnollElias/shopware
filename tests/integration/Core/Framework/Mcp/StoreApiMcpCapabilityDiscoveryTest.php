...
class StoreApiMcpCapabilityDiscoveryTest extends TestCase
{
    ...
    private function initialize(AbstractBrowser $browser): string
    {
     ...
     * @return list<string>
     */
    private function listTools(AbstractBrowser $browser, string $sessionId): array
    {
     ...
     */
    private function callTool(AbstractBrowser $browser, string $sessionId, string $name, array $arguments): array
    {
        return $this->rpc($browser, $sessionId, [
            'jsonrpc' => '2.0',
            'method' => 'tools/call',
     ...
     */
    private function rpc(AbstractBrowser $browser, string $sessionId, array $body): array
    {
        $browser->request(
            'POST',
            '/store-api/_mcp',
